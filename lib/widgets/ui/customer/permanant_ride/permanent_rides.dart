...
class PermanentRidesTabPage extends StatefulWidget {
  List<TripsHistoryModel> scheduleTrip;
  var chat;
  PermanentRidesTabPage({Key? key, required this.scheduleTrip,required this.chat}) : super(key: key);
...
class _ScheduledRidesTabPageState extends State<PermanentRidesTabPage> {
  int noOfSeat = 1;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: widget.scheduleTrip.length>0?ListView.builder(
        itemCount: widget.scheduleTrip.length,
        shrinkWrap: true,
            ...
            child: Padding(
                ...
                child:       Column(
                  ...
                  children: [
                    ...
                    widget.scheduleTrip[index].driverId=="waiting"?SizedBox(): Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Column(
                            children: [
                              Text("${widget.scheduleTrip[index].driverName}",style: const TextStyle(
                                  color: Colors.black,
                          ...
                          Column(
                            ...
                            children:  [
                              ...
                              Container(
                                ...
                                child: Text(DateFormat().format(DateTime.parse("${widget.scheduleTrip[index].time}")),style: const TextStyle(
                                    color: Colors.black45,
                                    fontWeight: FontWeight.w500,
                                    fontSize: 12
                                ),),
                              ),
                              Text("${widget.scheduleTrip[index].fareAmount}",style: const TextStyle(
                                  color: Colors.black45,
                                  fontWeight: FontWeight.w400,
                                  fontSize: 12
                              ),)
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Container(
                          width: 220,
                          child:  Text(
                            "${widget.scheduleTrip[index].originAddress}",
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Container(
                          width: 220,
                          child:  Text(
                            "${widget.scheduleTrip[index].destinationAddress}",
                            style:  const TextStyle(
                                color: Colors.black45,
                                fontWeight: FontWeight.w600,
                                fontSize: 13
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children:  [
                            ...
                            Text(DateFormat.yMMMMd('en_US') .format(DateTime.parse("${widget.scheduleTrip[index].startDate}"))),
                            Text("-"),
                            Text(DateFormat.yMMMMd('en_US') .format(DateTime.parse("${widget.scheduleTrip[index].endDate}")))
                          ],
                        ),
                        SizedBox(height: 5,),
                        Row(
                          ...
                          children:  [
                            ...
                            const SizedBox(width: 5,),
                            Text("${widget.scheduleTrip[index].startTimeO.toString()}"),
                            Text("-"),
                            Text("${widget.scheduleTrip[index].startTimeD.toString()}")
                          ],
                        ),
                    ...
                    widget.scheduleTrip[index].driverId=="waiting"?
                    ...
                    Container(
                      ...
                      child: Center(
                        child: Text(
                          widget.scheduleTrip[index].status!="started"? widget.scheduleTrip[index].driverId.toString().toUpperCase():"On The way",
                          style: const TextStyle(
                            color: Colors.white,
                            fontSize: 13,
                            fontWeight: FontWeight.w500,
                    ...
                    Column(
                      children: [
                        ...
                        //     //     onPressed: () {
                        //     //       Navigator.push(context, MaterialPageRoute(builder: (context)=>ChatDesign(tripsHistoryModel: widget.scheduleTrip[index],)));
                        //     //     },
                        //     //     icon: const Icon(
                        //     //       Icons.message,
                        //     //       color: AppColors.primaryColor,
                            ...
                            InkWell(
                              onTap: (){
                                FirebaseDatabase.instance.ref()
                                    ...
                                    .child(widget.scheduleTrip[index].key!)
                                    .remove().then((value)
                                {
                                  FirebaseDatabase.instance.ref()
                                      .child("drivers")
        ...
        },):Center(child: Text("No Permanent Rides available!")),
    );
  }
  saveRideRequestInformation(i) {
    ...
    Map originLocationMap = {
      ...
      //"key" : value
      "latitude": widget.scheduleTrip[i]?.origin["latitude"],
      "longitude": widget.scheduleTrip[i]?.origin["longitude"],
    };

    Map destinationLocationMap = {
      //yh ggogle map ni hai yh bs aik obj type hai jo key ki basis py work krta hai or save krta
      //"key" : value
      "latitude": widget.scheduleTrip[i]?.destination["latitude"],
      "longitude":widget.scheduleTrip[i]?.destination["longitude"],
    };
    ...
    Map userInformationMap = {
      ...
      "originAddress": widget.scheduleTrip[i].originAddress??"",
      "destinationAddress": widget.scheduleTrip[i].originAddress??"",
      "driverId": "waiting",
